...
namespace Common.FSM
{
	public class FSMState
	{
		private string name;
		private FSM owner;
		private Dictionary<string, FSMState> transitionMap; // holds the maping between the state names and its actual objects
		private List<FSMAction> actions; // list of actions to each state
